...
Additional rule packs (Ethical Design, AI Audit, AU Safety by Design, and more)
are available with a Pro license key. See https://runhalo.dev/pricing for details.
