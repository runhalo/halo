...
- **180 rules across 17 compliance packs** — up from 100 rules in v0.4.0
- **New ASAA pack** — 20 rules for App Store Accountability Act (TX/AL/LA/UT)
- **13 jurisdictions** covered: COPPA 2.0, AADC, CalOPPA, FERPA, KOSA, GDPR-K, ASAA, and more
...
- Engine updated to v1.1.0 with 160+ rules and 15 packs
