 ...
 *   AI-AUDIT-002          — No hardcoded secrets; key comes from env var
 *   AI-AUDIT-005          — No rejectUnauthorized:false, no CORS wildcard
 *   coppa-default-020     — isPublic defaults to false
 *   AU-SBD-001            — isPublic / profileVisible both default false
 */
