 ...
 *   ETHICAL-001       — No IntersectionObserver+loadMore / InfiniteScroll
 *   ETHICAL-002       — No dailyStreak / consecutiveDays pressure patterns
 *   ETHICAL-003       — No loot_box / gacha / Math.random reward patterns
 *   ETHICAL-004       — No "hurry", "limited time", "missing out" language
 *   ETHICAL-005       — No CountdownTimer / "only N left" / "offer ends in"
 *   AU-SBD-005        — No autoplay:true, no re-engagement notification triggers
 */
 ...
 *
 * ETHICAL-001 flags IntersectionObserver+isIntersecting+loadMore patterns
 * and InfiniteScroll imports.  This module uses a plain pagination counter
 * instead, giving users a clear stopping point.
 */
 ...
 *
 * ETHICAL-002 matches dailyStreak / consecutiveDays identifiers.
 * This function uses totalDaysActive (cumulative) instead.
 */
 ...
 *
 * ETHICAL-003 matches Math.random()*reward, loot_box, gacha, openCrate,
 * rarityTable, dropRates.  None of those patterns appear here.
 */
